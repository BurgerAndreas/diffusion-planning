...
base = {
    "diffusion": {
        ...
        "loss_type": "l2",
        "n_train_steps": 2e6,
        "batch_size": 64, # 12GB VRAM: 64-256
        "learning_rate": 2e-4,
...
maze2d_large_v1_3x3 = {
    **maze2d_large_v1,
    "diffusion_planner": {
        ...
        "overlap": np.array([1, 1]),
        # desired trajectory
        "global_start": np.array([1.5, 2.5], dtype=float),
        "global_goal": np.array([19.5, 28.5], dtype=float),
    },
}
...
maze2d_large_v1_7x7 = {
    **maze2d_large_v1,
    "diffusion_planner": {
        ...
        "overlap": np.array([1, 1]),
        # desired trajectory
        "global_start": 'bottom_left',
        "global_goal": 'top_right',
    },
}
